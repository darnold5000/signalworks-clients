...
export type TenantTechnicalProfile = {
  ...
  database_infrastructure_notes: string | null;
  email_provider_tier: string | null;
  google_workspace_enabled: boolean | null;
  domain_email_provider: string | null;
  stripe_connection_status: string | null;
  stripe_platform_account_id: string | null;
  stripe_test_mode_enabled: boolean | null;
  ...
  database_production_dedicated: boolean | null;
