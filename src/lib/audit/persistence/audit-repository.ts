...
export async function saveSearchVisibilitySnapshot(
  ...
  const { error } = await supabase.from("audit_search_visibility").upsert({
    ...
    demand_provider_request_attempted: snapshot.searchDemandDiagnostics?.providerRequestAttempted ?? false,
    demand_provider_http_status: snapshot.searchDemandDiagnostics?.providerHttpStatus ?? null,
    demand_provider_task_status: snapshot.searchDemandDiagnostics?.providerTaskStatus ?? null,
    demand_response_status: snapshot.searchDemandDiagnostics?.responseStatus ?? "not_attempted",
    demand_parse_status: snapshot.searchDemandDiagnostics?.parseStatus ?? "not_attempted",
    demand_result_count: snapshot.searchDemandDiagnostics?.resultCount ?? null,
    demand_persistence_attempted: snapshot.searchDemandDiagnostics?.persistenceAttempted ?? false,
    demand_persistence_status: snapshot.searchDemandDiagnostics?.persistenceStatus ?? "not_attempted",
