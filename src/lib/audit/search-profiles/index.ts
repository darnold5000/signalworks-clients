...
const PROFILES: Array<SearchProfile & { signals: RegExp }> = [
  ...
  { key: "fitness_gym", signals: /\bgym\b|\bfitness\b|\bpersonal training\b|\bstrength training\b/i, applicable: true, baseTerms: ["gym", "fitness center", "personal trainer", "strength training", "fitness classes"] },
